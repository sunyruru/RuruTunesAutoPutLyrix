namespace TagGuru
{
    ...
    internal class LyricsUpdater
    {
        ...
        public void UpdateLyrics()
        {
            ...
            if ((count >= 500) && (MessageBox.Show("500곡 이상을 선택하셨습니다. 리스트에서 앨범커버 보기 기능이 메모리 오류를 낼수 있으므로 미리보기를 꺼두시겠습니까 ?", "TagGuru 오류", MessageBoxButtons.YesNo) == DialogResult.Yes))
            {
