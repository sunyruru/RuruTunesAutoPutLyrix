namespace RuruTunesAutoPutLyrix
{
    ...
    public class MassUpdater : Form
    {
        ...
        public RuruTunesAutoPutLyrix iMain;
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "RuruTunesAutoPutLyrix MassUpdater";
        ...
        private void MassUpdater_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (this.lu.onwork)
            {
                if (MessageBox.Show("작업을 중단하시겠습니까 ?", "RuruTunesAutoPutLyrix", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
